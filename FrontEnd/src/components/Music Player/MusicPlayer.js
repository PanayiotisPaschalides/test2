...
class MusicPlayer extends Component {
  ...
  handleMute()
  {
    ...
    this.audioContainer.volume = 0;
    this.setState({volume: 0})
    }
    else{
      this.audioContainer.volume = 1;
  ...
  render() {
    const { btnColor, playlist } = this.props
      ...
      <div className="player-container" style={this.props.style}>
        ...
        <div className="info-and-control">
          <div className="music-info">
            <label className="title">{activeMusic.title}</label>
          </div>
          ...
          >
            ...
            <i className="left-time">-{this._formatTime(this.state.leftTime)}</i>
            ...
            <div className="volume-container">
              <div className="volume-icon" onClick={this.handleMute.bind(this)}>
